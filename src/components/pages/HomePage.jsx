          ...
          <div className="text-center text-white space-y-12 p-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="flex gap-10 text-center justify-center pt-5">
                ...
                <button className="px-6 py-3 rounded-xl border border-white/10 bg-white/5 hover:bg-white hover:text-black transition">
                  Download Resume
                </button>
              </div>
            </div>
          ...
          <div className="bg-black text-white px-10 py-16">
            ...
            <div className="mb-10 max-w-6xl mx-auto space-y-6 ">
              ...
              <p className="text-gray-400 mt-4 max-w-5xl leading-7 text-xl">
                I am currently working as a Full Stack Developer focused on
                building scalable, maintainable and high-performance web
                applications using modern MERN stack technologies.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
              ...
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
                ...
                <p className="text-gray-400 mt-3 text-sm leading-6">
                  Experienced in React, Next.js, Tailwind CSS and building
                  scalable UI systems.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
                ...
                <p className="text-gray-400 mt-3 text-sm leading-6">
                  Working in real project environments with team collaboration
